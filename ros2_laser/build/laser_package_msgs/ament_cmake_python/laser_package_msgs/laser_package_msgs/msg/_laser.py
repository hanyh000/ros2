...
class Metaclass_Laser(type):
    """Metaclass of message 'Laser'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('laser_package_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'laser_package_msgs.msg.Laser')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__laser
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__laser
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__laser
            cls._TYPE_SUPPORT = module.type_support_msg__msg__laser
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__laser
...
class Laser(metaclass=Metaclass_Laser):
    """Message class 'Laser'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.pattern_name = kwargs.get('pattern_name', str())
    ...
    def __eq__(self, other):
        ...
        if self.intensities != other.intensities:
            return False
        if self.pattern_name != other.pattern_name:
            return False
        return True
    ...
    def pattern_name(self, value):
        if __debug__:
            assert \
                ...
                "The 'pattern_name' field must be of type 'str'"
        self._pattern_name = value
