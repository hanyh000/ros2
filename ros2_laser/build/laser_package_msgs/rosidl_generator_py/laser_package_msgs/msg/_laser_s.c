...
bool laser_package_msgs__msg__laser__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("laser_package_msgs.msg._laser.Laser", full_classname_dest, 35) == 0);
  }
  laser_package_msgs__msg__Laser * ros_message = _ros_message;
  {  // angle_min
  ...
  {  // pattern_name
    PyObject * field = PyObject_GetAttrString(_pymsg, "pattern_name");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->pattern_name, PyBytes_AS_STRING(encoded_field));
...
{
  /* NOTE(esteve): Call constructor of Laser */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("laser_package_msgs.msg._laser");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Laser");
  ...
  {  // pattern_name
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->pattern_name.data,
      strlen(ros_message->pattern_name.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "pattern_name", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
