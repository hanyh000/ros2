...
static const _Laser_type_support_symbol_names_t _Laser_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, laser_package_msgs, msg, Laser)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, laser_package_msgs, msg, Laser)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, laser_package_msgs, msg, Laser)() {
  return &::laser_package_msgs::msg::rosidl_typesupport_c::Laser_message_type_support_handle;
}
