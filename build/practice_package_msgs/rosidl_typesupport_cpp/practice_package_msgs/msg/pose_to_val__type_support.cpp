...
static const _PoseToVal_type_support_symbol_names_t _PoseToVal_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, practice_package_msgs, msg, PoseToVal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, practice_package_msgs, msg, PoseToVal)),
  }
};
...
{
  return &::practice_package_msgs::msg::rosidl_typesupport_cpp::PoseToVal_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, practice_package_msgs, msg, PoseToVal)() {
  return get_message_type_support_handle<practice_package_msgs::msg::PoseToVal>();
}
